...
<div id="container">
        ...
        <nav id="SubNavi">
            <ul class="parent flex inner" data-liststyle="none">
                ...
                <li class="parent-data p-d fs16">
                    <a href="/board/brochure/list" class="parent-link p-link" title="브로셔 이동">브로셔</a>
                </li>
            </ul>
        </nav>
    </div>
    <div id="Cont">
        <div class="inner">
            <article id="board_viewBox">
                <div class="view_title">
                    <p class="title">NWA 공법 카탈로그</p>
                    <span class="writer">작성자 : 관리자</span>
                    <span class="date">22-06-28</span>
                    <span class="fileDown">첨부파일 : <a href="/storage/brochure/2022/08/18/GElTQwRrsHafdMM0OuAFRFg9xwJY7WWSN3ubUpLX.pdf" download="카탈로그_NWA 공법.pdf">카탈로그_NWA 공법.pdf</a></span>
                    <span class="file-down-btn"><a href="/storage/brochure/2022/08/18/GElTQwRrsHafdMM0OuAFRFg9xwJY7WWSN3ubUpLX.pdf" download="카탈로그_NWA 공법.pdf">다운로드
                        </a></span>
                </div>
                ...
                <div class="list">
                    <dl>
                        <dt>Prev</dt>
                        <dd>
                            <a href="http://www.gdcon.co.kr/board/brochure/view?id=15">자립식 흙막이 공법 카탈로그</a>
                        </dd>
                    </dl>

                </div>
                <div class="toList_box">
                    <a href="/board/brochure/list">목록</a>
                </div>
            </article>
        </div>
    </div>
